...
HD_PWD='C:/Users/Darius/Proiect_PSN_Cifru/Proiect_PSN_Cifru.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Proiect_portmapuri.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Proiect_portmapuri.tcl
