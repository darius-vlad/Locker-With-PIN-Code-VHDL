...
HD_PWD='C:/Users/Darius/Proiect_PSN_Cifru/Proiect_PSN_Cifru.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Proiect_portmapuri.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Proiect_portmapuri.tcl -notrace
